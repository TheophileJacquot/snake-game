...
function setup() {
  // on charge le modèle
  classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/8uIN_Vb4C/model.json");
...
function keyPressed() {
  switch (keyCode) {
    ...
    case 40: // 40 à flèche du bas
      goDown();
      break;
    case 37: // 37 flèche de gauche
      goLeft();
      break;
    case 39: // 39 flèche de droite
      goRight();
      break;
  }
}
